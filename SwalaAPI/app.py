...
class hardware(Resource):
    def get(self):
        ...
        connect=pymysql.connect(host="localhost",user="root",password="",database="Allware")
    ...
    def post(self):
        #Function to create hardware in our Allware
        #table name = hardware
        data = request.json
        ...
        connection=pymysql.connect(host="localhost",user="root",password="",database="Allware")
